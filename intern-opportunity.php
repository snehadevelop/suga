            ...
            <div class="banner-content">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Intern Opportunity</li>
                    </ol>
                </nav>
                <h1>Intern Opportunity</h1>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="main-contact-box">
                <div class="heading-box">
                    <h2 class="color-secondary  text-uppercase pb-4">Intern Opportunity</h2>
                </div>
